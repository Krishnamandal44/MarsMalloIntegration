package enc.test.marsmallointegration;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        view = v;
        if (v.getId() == R.id.check_permission) {
            if (checkPermission()) {
            ...
            case PERMISSION_REQUEST_CODE:
                if (grantResults.length > 0) {
                    ...
                    if (locationAccepted && cameraAccepted)
                        Toast.makeText(this, "Permission Granted, Now you can access location data and camera.",
                                Toast.LENGTH_SHORT).show();
                    else {
                        Toast.makeText(this, "Permission Denied, You cannot access location data and camera.",
                                Toast.LENGTH_SHORT).show();
